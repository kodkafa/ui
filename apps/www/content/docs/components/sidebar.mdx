...
- [#5593](https://github.com/kodkafa/ui/pull/5593) - Improved setOpen callback logic in `<SidebarProvider>`.
...
- [#5491](https://github.com/kodkafa/ui/pull/5491) - Moved `text-sidebar-foreground` from `<SidebarProvider>` to `<Sidebar>` component.
